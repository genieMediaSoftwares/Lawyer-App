...
class AISmartQuestionsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AISmartQuestionsScreen> createState() =>
      _AISmartQuestionsScreenState();
}

class _AISmartQuestionsScreenState
    extends ConsumerState<AISmartQuestionsScreen> {
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _ChecklistItem(
                      text: "Documents Uploaded & Processed",
                      isSuccess: true,
                    ),
                    _ChecklistItem(
                      text:
                          "Legal Category Detected (${analysis?.category ?? 'General'})",
                      isSuccess: true,
                    ),
                    _ChecklistItem(
                      text:
                          "Timeline Extracted (${analysis?.detectedTimeline.length ?? 0} events)",
                      isSuccess: (analysis?.detectedTimeline.length ?? 0) > 0,
                    ),
                    _ChecklistItem(
                      text:
                          "Priority Detected (${analysis?.priority ?? 'Medium'})",
                      isSuccess: true,
                    ),
