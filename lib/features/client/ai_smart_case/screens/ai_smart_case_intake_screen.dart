...
class AISmartCaseIntakeScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AISmartCaseIntakeScreen> createState() =>
      _AISmartCaseIntakeScreenState();
}

class _AISmartCaseIntakeScreenState
    extends ConsumerState<AISmartCaseIntakeScreen> {
  ...
  void _onProceed() async {
    ...
    if (state.selectedFiles.isEmpty &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Please upload at least one document or record a voice note to proceed.',
          ),
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText:
                      "Add any extra details or dates if not mentioned in documents...",
