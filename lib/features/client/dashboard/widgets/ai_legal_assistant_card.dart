...
// Built from AppColors' `illustration*` hex-string constants rather than
// literal hex, per screen — these are XML attribute strings inside SVG
// markup, so they need `#RRGGBB` text, not a Dart `Color`, but the palette
// definition itself still lives in exactly one place.
const String robotBodySvg = '''
<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="headGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#${AppColors.illustrationWhite}" />
      <stop offset="100%" stop-color="#${AppColors.illustrationSlate200}" />
    </linearGradient>
    <linearGradient id="visorGrad" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#${AppColors.illustrationSlate800}" />
      <stop offset="100%" stop-color="#${AppColors.illustrationSlate900}" />
    </linearGradient>
    <linearGradient id="blueGlow" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#${AppColors.illustrationSkyLight}" />
      <stop offset="100%" stop-color="#${AppColors.illustrationSkyDeep}" />
    </linearGradient>
  </defs>

  <!-- Antenna -->
  <line x1="50" y1="28" x2="50" y2="12" stroke="#${AppColors.illustrationSlate500}" stroke-width="2" />
  <circle cx="50" cy="10" r="3.5" fill="url(#blueGlow)" />

  <!-- Ear headphones -->
  <rect x="10" y="46" width="6" height="18" rx="3" fill="#${AppColors.illustrationSlate400}" />
  <rect x="84" y="46" width="6" height="18" rx="3" fill="#${AppColors.illustrationSlate400}" />
  <circle cx="13" cy="55" r="6" fill="url(#headGrad)" stroke="#${AppColors.illustrationSlate400}" stroke-width="0.8"/>
  <circle cx="87" cy="55" r="6" fill="url(#headGrad)" stroke="#${AppColors.illustrationSlate400}" stroke-width="0.8"/>

  <!-- Head -->
  <rect x="17" y="26" width="66" height="54" rx="27" fill="url(#headGrad)" stroke="#${AppColors.illustrationSlate300}" stroke-width="1" />

  <!-- Visor -->
  <rect x="27" y="36" width="46" height="32" rx="14" fill="url(#visorGrad)" stroke="#${AppColors.illustrationSlate700}" stroke-width="0.8" />

  <!-- Glowing Blue Eyes -->
  <rect x="35" y="45" width="8" height="12" rx="4" fill="#${AppColors.illustrationCyan}" />
  <rect x="57" y="45" width="8" height="12" rx="4" fill="#${AppColors.illustrationCyan}" />

  <!-- Smile -->
  <path d="M46,62 Q50,65 54,62" stroke="#${AppColors.illustrationCyan}" stroke-width="1.8" fill="none" stroke-linecap="round" />

  <!-- Neck & Shoulders -->
  <path d="M34,80 C34,80 38,88 50,88 C62,88 66,80 66,80 Z" fill="url(#headGrad)" stroke="#${AppColors.illustrationSlate300}" stroke-width="0.8" />
  <circle cx="50" cy="83" r="3" fill="#${AppColors.illustrationSlate200}" stroke="#${AppColors.illustrationSlate400}" stroke-width="0.8" />
</svg>
''';
...
<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="blueScale" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#${AppColors.illustrationSkyLight}" />
      <stop offset="100%" stop-color="#${AppColors.illustrationBlueDeep}" />
    </linearGradient>
  </defs>
...
class AILegalAssistantCard extends StatelessWidget {
      ...
      builder: (context, constraints) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            color: AppColors.aiSurfaceBackground, // Deep midnight blue/black background
            borderRadius: BorderRadius.circular(24), // Rounded corners (24px)
            border: Border.all(
              color: AppColors.info.withValues(alpha: 0.4), // Thin blue border
              width: 1.0,
            ),
            boxShadow: [
              BoxShadow(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: AppColors.aiSurfaceBackground.withValues(alpha: 0.6),
                        border: Border.all(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              color: AppColors.mutedText, // Muted grey-blue text
  ...
  Widget _buildAIPoweredBadge(bool isExtraSmall) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.success.withValues(alpha: 0.12), // Green transparency
      ...
      child: FittedBox(
        ...
        child: Row(
          ...
          children: [
            Icon(
              Icons.bolt,
              color: AppColors.statusSuccessFg, // Vibrant green
...
class _ConstellationPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paintDot = Paint()
      ..color = AppColors.statInfo.withValues(alpha: 0.16)
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Container(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: AppColors.aiSurfaceBackground.withValues(alpha: 0.5),
            border: Border.all(
              color: AppColors.info.withValues(alpha: 0.2 + 0.3 * _animation.value),
              width: 1.0,
            ),
            boxShadow: [
              BoxShadow(
                color: AppColors.info.withValues(alpha: 0.06 * _animation.value),
                blurRadius: 10,
      ...
      child: GestureDetector(
        ...
        child: AnimatedScale(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: AppColors.primaryBackground, // Dark pill-shaped button background
              borderRadius: BorderRadius.circular(20),
              border: Border.all(
                color: AppColors.warning, // Outlined gold border
                width: 1.2,
              ),
              boxShadow: [
                BoxShadow(
                  color: AppColors.warning.withValues(alpha: _isHovered ? 0.25 : 0.12),
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              gradient: LinearGradient(
                                colors: [
                                  AppColors.primaryText.withValues(alpha: 0.0),
                ...
                Row(
                  ...
                  children: [
                    Text(
                      "Ask Now",
                      style: TextStyle(
                        color: AppColors.warning, // Gold text
                    ...
                    Icon(
                      Icons.chevron_right,
                      color: AppColors.warning, // Gold icon
