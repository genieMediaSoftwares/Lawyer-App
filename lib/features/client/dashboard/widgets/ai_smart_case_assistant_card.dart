      ...
      builder: (context, child) {
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(0xFF8B5CF6).withValues(alpha: 0.12 * _glowAnimation.value), // Purple AI glow
                blurRadius: 14,
                spreadRadius: 1,
              ),
              BoxShadow(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                icon: const Icon(Icons.document_scanner, size: 17, color: Colors.black),
                label: const Text(
