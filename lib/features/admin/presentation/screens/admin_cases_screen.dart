...
class _AdminCasesScreenState extends ConsumerState<AdminCasesScreen> {
    ...
    showModalBottomSheet(
      ...
      builder: (bottomSheetCtx) => Padding(
        ...
        child: Column(
          ...
          children: [
            const Text('Update Case Status', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 16),
            _buildStatusTile(bottomSheetCtx, caseId, 'Pending', Colors.amber),
            _buildStatusTile(bottomSheetCtx, caseId, 'In Progress', Colors.lightBlue),
  ...
  Widget _buildStatusTile(BuildContext context, String caseId, String status, Color color) {
    return ListTile(
      ...
      title: Text(status, style: const TextStyle(color: Colors.white, fontSize: 15)),
      onTap: () async {
