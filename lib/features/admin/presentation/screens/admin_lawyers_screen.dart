    ...
    showDialog(
      ...
      builder: (dialogCtx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              'Select action for this advocate profile:',
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              Navigator.pop(dialogCtx);
              final repo = ref.read(adminRepositoryProvider);
              await repo.verifyLawyer(lawyerId: lawyerId, status: 'verified');
              ref.refresh(adminLawyersProvider);
              ref.refresh(adminPendingLawyersProvider);
              ref.refresh(adminStatsProvider);
            },
            ...
            child: Column(
              children: [
                TextField(
                  ...
                  style: const TextStyle(color: Colors.white),
                  onChanged: (val) {
                    ref.read(adminLawyerFilterProvider.notifier).state = filter
                        .copyWith(search: val);
                  },
                  decoration: InputDecoration(
                    hintText:
                        'Search lawyers by name, specialization, bar no...',
                    ...
                    suffixIcon: _searchController.text.isNotEmpty
                        ? IconButton(
                            ...
                            onPressed: () {
                              ...
                              ref
                                  .read(adminLawyerFilterProvider.notifier)
    ...
    return ChoiceChip(
      ...
      onSelected: (selected) {
        if (selected) {
          ...
          ref.read(adminLawyerFilterProvider.notifier).state = filter.copyWith(
