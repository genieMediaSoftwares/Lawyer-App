...
class ReviewRecord {
  ...
  factory ReviewRecord.fromJson(Map<String, dynamic> json) {
    ...
    return ReviewRecord(
      ...
      clientId:
          clientData['_id'] ?? (json['client'] is String ? json['client'] : ''),
...
final lawyerReviewsProvider = FutureProvider.family<List<ReviewRecord>, String>(
  (ref, lawyerId) async {
...
final combinedReviewsProvider =
    Provider.family<AsyncValue<List<ReviewRecord>>, String>((ref, lawyerId) {
            ...
            data: (cases) {
              ...
              for (final c in cases) {
                final isLawyerCase =
                    ...
                    c.selectedLawyerId == lawyerId;
                final hasCaseReview =
                    c.rating != null &&
                    c.rating! > 0 &&
                    c.review != null &&
                    c.review!.trim().isNotEmpty;
                if (isLawyerCase && hasCaseReview) {
                  final exists = apiReviews.any(
                    (r) =>
                        r.comment.trim() == c.review!.trim() &&
