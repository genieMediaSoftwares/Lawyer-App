...
final adminClientFilterProvider = StateProvider<AdminClientFilter>((ref) => AdminClientFilter());

final adminClientsProvider = FutureProvider.autoDispose<List<AdminClientSummary>>((ref) async {
  final repo = ref.watch(adminRepositoryProvider);
  final filter = ref.watch(adminClientFilterProvider);
  return await repo.getClients(search: filter.search, status: filter.status);
});
...
final adminLawyerFilterProvider = StateProvider<AdminLawyerFilter>((ref) => AdminLawyerFilter());

final adminLawyersProvider = FutureProvider.autoDispose<List<AdminLawyerSummary>>((ref) async {
  final repo = ref.watch(adminRepositoryProvider);
  final filter = ref.watch(adminLawyerFilterProvider);
  return await repo.getLawyers(search: filter.search, verificationStatus: filter.verificationStatus);
});

final adminPendingLawyersProvider = FutureProvider.autoDispose<List<AdminLawyerSummary>>((ref) async {
  final repo = ref.watch(adminRepositoryProvider);
...
final adminCaseFilterProvider = StateProvider<AdminCaseFilter>((ref) => AdminCaseFilter());

final adminCasesProvider = FutureProvider.autoDispose<List<CaseModel>>((ref) async {
  final repo = ref.watch(adminRepositoryProvider);
...
// Documents Provider
final adminDocumentsProvider = FutureProvider.autoDispose<List<DocumentModel>>((ref) async {
  final repo = ref.watch(adminRepositoryProvider);
  return await repo.getDocuments();
});

// AI Analytics Provider
final adminAiAnalyticsProvider = FutureProvider.autoDispose<AdminAiAnalyticsModel>((ref) async {
  final repo = ref.watch(adminRepositoryProvider);
  return await repo.getAiAnalytics();
});

// Support Tickets Provider
final adminSupportTicketsProvider = FutureProvider.autoDispose<List<IssueModel>>((ref) async {
  final repo = ref.watch(adminRepositoryProvider);
...
final adminAppointmentsProvider = FutureProvider.autoDispose<List<AppointmentModel>>((ref) async {
  final repo = ref.watch(adminRepositoryProvider);
