class DocumentModel {
  ...
  String get docCategory => (category != null && category!.isNotEmpty) ? category! : 'Property';
  String get docUploadedBy => (uploadedBy != null && uploadedBy!.isNotEmpty) ? uploadedBy! : 'Client User';
