...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'cancel': 'Cancel',
      'enter_password_to_confirm': 'Enter your current password to confirm deletion:',
    ...
    'te': {
      ...
      'change_password_subtitle': 'మీ ఖాతా పాస్‌వర్డ్‌ను భద్రంగా అప్‌డేట్ చేయండి',
      'delete_account': 'ఖాతాను తొలగించండి (Delete Account)',
      'delete_account_subtitle': 'మీ ప్రొఫైల్ మరియు డేటాను శాశ్వతంగా తొలగించండి',
      ...
      'cancel': 'రద్దు చేయి',
      'enter_password_to_confirm': 'ఖాతా తొలగింపును నిర్ధారించడానికి మీ ప్రస్తుత పాస్‌వర్డ్‌ను నమోదు చేయండి:',
    ...
    'hi': {
      ...
      'change_password_subtitle': 'अपने खाते का पासवर्ड सुरक्षित रूप से अपडेट करें',
      'delete_account': 'खाता हटाएं (Delete Account)',
      'delete_account_subtitle': 'अपनी प्रोफ़ाइल और सभी डेटा को स्थायी रूप से हटाएँ',
      ...
      'cancel': 'रद्द करें',
      'enter_password_to_confirm': 'हटाने की पुष्टि के लिए अपना वर्तमान पासवर्ड दर्ज करें:',
